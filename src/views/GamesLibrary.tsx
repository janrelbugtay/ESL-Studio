...
export function GamesLibrary({
  ...
  const gameTemplates = [
    { id: "mystery-box", title: "Mystery Box", icon: "🎁", color: "bg-orange-100 text-orange-600" },
    { id: "neon-chain", title: "Neon Chain", icon: "⚡", color: "bg-cyan-100 text-cyan-600" },
    { id: "bubble-pop", title: "Bubble Pop", icon: "🫧", color: "bg-blue-100 text-blue-600" },
    { id: "flashcards-match", title: "Flashcards Match", icon: "🎴", color: "bg-indigo-100 text-indigo-600" },
    { id: "bubble-sentence-pro", title: "Bubble Island", icon: "🎈", color: "bg-sky-100 text-sky-600" },
    { id: "yoga-quiz", title: "Yoga Quiz", icon: "🧘‍♀️", color: "bg-emerald-100 text-emerald-600" },
  ];
                  ...
                  >
                    ...
                    <div className="flex-1 flex flex-col">
                      ...
                      <div className="flex justify-between items-start mb-4">
                        ...
                        <div className="w-12 h-12 bg-white shadow-sm border-2 border-slate-100 rounded-2xl flex items-center justify-center font-bold text-2xl group-hover:scale-110 transition-transform shrink-0 z-20 relative">
                          {gameTemplates.find(t => t.id === game.gameType)?.icon || '🎮'}
                        </div>
                      </div>
            ...
            <div className="grid grid-cols-2 gap-4 max-h-[60vh] overflow-y-auto pr-2 custom-scrollbar">
              {gameTemplates.map((template) => (
                <button
                  ...
                  className="flex flex-col items-center gap-3 p-4 rounded-2xl border-2 border-slate-100 hover:border-brand-purple hover:bg-purple-50 transition-colors text-center group"
                >
                  <div className={`w-16 h-16 rounded-2xl flex items-center justify-center text-3xl shadow-sm ${template.color}`}>
                    {template.icon}
                  </div>
                  <span className="font-bold text-slate-700 group-hover:text-brand-purple">
                    {template.title}
                  </span>
                </button>
              ))}
